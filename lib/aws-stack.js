...
function validateStackConfig(stackConfig, validate){
    ...
    stackConfig.stackPath         = stackConfig.stackPath         || `./infrastructure/${stackConfig.stackTemplateType}`;
...
function prepareParameters(stackConfig){
    let localParams = require(`${ExecDir}/${stackConfig.stackParamsPath}/parameters-${stackConfig.stackEnv}.json`) || [];
