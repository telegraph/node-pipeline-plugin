...
class AwsStack {
        ...
        return new Promise((resolve, reject) => {
            ...
            let interval = setInterval(() => {
                this._awsCf.describeStacks(request, (error, response) => {
                    ...
                    if(response.Stacks[0].StackStatus.endsWith('FAILED') || response.Stacks[0].StackStatus.includes('FAILED')){
    ...
    publish(){
        ...
        return new Promise((resolve, reject) => {
            ...
            // let request = {
            //     localDir: this._stackConfig.stackPath,
            //     s3Params: {
            //         Bucket: s3Bucket,
            //         Prefix: s3Key,
            //     }
